...
JSON format, you can issue a GET request to +/users/bob/adjustments.json+. 
...
karma score, latest activity, etc.
...
Returns a history of all karma adjustments for bob's "plants" bucket.
  ...
  PUT /users/bob/buckets/plants/adjustments/245
  
Modify the details for one particular adjustment from user Bob.
