ActionController::Routing::Routes.draw do |map|
  ...
  map.with_options :controller => :adjustments do |m|
    ...
    m.user_bucket_adjustments    '/users/:user_permalink/buckets/:bucket_permalink/adjustments',     :action => :create, :conditions => { :method => :post }
    m.user_bucket_adjustments    '/users/:user_permalink/buckets/:bucket_permalink/adjustments',     :action => :index,  :conditions => { :method => :get }
  end
